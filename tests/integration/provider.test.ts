...
describe("Provider", () => {
    ...
    describe("#getBytecodeByHash(txHash)", () => {
        it("should return bytecode of a contract", async () => {
            ...
            const tokenFactoryDepsHash = ethers.utils.hexlify(utils.hashBytecode(testnetPaymasterBytecode)); // "0x0100012539970918b0ab79e00660723a76fed0d6dac333c9298fdbb8628407f2";
