...
exports.IStateTransitionChainFactory = void 0;
const ethers_1 = require("ethers");
class IStateTransitionChainFactory {
    static connect(address, signerOrProvider) {
        return new ethers_1.Contract(address, _abi, signerOrProvider);
    }
}
exports.IStateTransitionChainFactory = IStateTransitionChainFactory;
const _abi = [
    {
        anonymous: false,
        inputs: [
