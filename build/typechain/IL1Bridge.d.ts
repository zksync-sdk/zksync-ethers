...
export interface IL1BridgeInterface extends Interface {
    getFunction(nameOrSignature: "bridgehub" | "bridgehubConfirmL2Transaction" | "bridgehubDeposit" | "bridgehubDepositBaseToken" | "claimFailedDeposit" | "deposit" | "depositHappened" | "finalizeWithdrawal" | "isWithdrawalFinalizedShared" | "l2BridgeAddress"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "BridgehubDepositFinalized" | "BridgehubDepositInitiatedSharedBridge" | "ClaimedFailedDepositSharedBridge" | "DepositInitiatedSharedBridge" | "WithdrawalFinalizedSharedBridge"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "bridgehubDeposit", values: [BigNumberish, AddressLike, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "isWithdrawalFinalizedShared", values: [BigNumberish, BigNumberish, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "isWithdrawalFinalizedShared", data: BytesLike): Result;
...
export declare namespace BridgehubDepositInitiatedSharedBridgeEvent {
    type InputTuple = [
        chainId: BigNumberish,
        txDataHash: BytesLike,
        from: AddressLike,
...
export declare namespace DepositInitiatedSharedBridgeEvent {
    type InputTuple = [
        chainId: BigNumberish,
        l2DepositTxHash: BytesLike,
        from: AddressLike,
...
export interface IL1Bridge extends BaseContract {
    ...
    getFunction(nameOrSignature: "bridgehub"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "isWithdrawalFinalizedShared"): TypedContractMethod<[
        _chainId: BigNumberish,
        _l2BatchNumber: BigNumberish,
        _l2MessageIndex: BigNumberish
    ], [
    ...
    getEvent(key: "BridgehubDepositInitiatedSharedBridge"): TypedContractEvent<BridgehubDepositInitiatedSharedBridgeEvent.InputTuple, BridgehubDepositInitiatedSharedBridgeEvent.OutputTuple, BridgehubDepositInitiatedSharedBridgeEvent.OutputObject>;
    ...
    getEvent(key: "DepositInitiatedSharedBridge"): TypedContractEvent<DepositInitiatedSharedBridgeEvent.InputTuple, DepositInitiatedSharedBridgeEvent.OutputTuple, DepositInitiatedSharedBridgeEvent.OutputObject>;
    ...
    filters: {
        ...
        "BridgehubDepositInitiatedSharedBridge(uint256,bytes32,address,address,address,uint256)": TypedContractEvent<BridgehubDepositInitiatedSharedBridgeEvent.InputTuple, BridgehubDepositInitiatedSharedBridgeEvent.OutputTuple, BridgehubDepositInitiatedSharedBridgeEvent.OutputObject>;
        BridgehubDepositInitiatedSharedBridge: TypedContractEvent<BridgehubDepositInitiatedSharedBridgeEvent.InputTuple, BridgehubDepositInitiatedSharedBridgeEvent.OutputTuple, BridgehubDepositInitiatedSharedBridgeEvent.OutputObject>;
        ...
        "DepositInitiatedSharedBridge(uint256,bytes32,address,address,address,uint256)": TypedContractEvent<DepositInitiatedSharedBridgeEvent.InputTuple, DepositInitiatedSharedBridgeEvent.OutputTuple, DepositInitiatedSharedBridgeEvent.OutputObject>;
        DepositInitiatedSharedBridge: TypedContractEvent<DepositInitiatedSharedBridgeEvent.InputTuple, DepositInitiatedSharedBridgeEvent.OutputTuple, DepositInitiatedSharedBridgeEvent.OutputObject>;
