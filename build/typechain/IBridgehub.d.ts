...
export interface IBridgehubInterface extends Interface {
    getFunction(nameOrSignature: "L1_CHAIN_ID" | "acceptAdmin" | "addChainTypeManager" | "addTokenAssetId" | "admin" | "assetIdIsRegistered" | "assetRouter" | "assetTracker" | "baseToken" | "baseTokenAssetId" | "bridgeBurn" | "bridgeMint" | "bridgeRecoverFailedTransfer" | "chainTypeManager" | "chainTypeManagerIsRegistered" | "createNewChain" | "ctmAssetIdFromAddress" | "ctmAssetIdFromChainId" | "ctmAssetIdToAddress" | "forwardTransactionOnGatewayWithBalanceChange" | "getAllZKChainChainIDs" | "getAllZKChains" | "getZKChain" | "interopCenter" | "l1CtmDeployer" | "l2TransactionBaseCost" | "messageRoot" | "migrationPaused" | "proveL1ToL2TransactionStatus" | "proveL2LogInclusion" | "proveL2MessageInclusion" | "registerAlreadyDeployedZKChain" | "registerLegacyChain" | "registerSettlementLayer" | "removeChainTypeManager" | "requestL2TransactionDirect" | "requestL2TransactionTwoBridges" | "routeBridgehubConfirmL2Transaction" | "routeBridgehubDeposit" | "setAddresses" | "setCTMAssetAddress" | "setPendingAdmin" | "settlementLayer" | "whitelistedSettlementLayers"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "assetTracker", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "forwardTransactionOnGatewayWithBalanceChange", values: [
        BigNumberish,
        BytesLike,
        BigNumberish,
        BigNumberish,
    ...
    decodeFunctionResult(functionFragment: "assetTracker", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "forwardTransactionOnGatewayWithBalanceChange", data: BytesLike): Result;
...
export interface IBridgehub extends BaseContract {
    ...
    getFunction(nameOrSignature: "assetTracker"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "forwardTransactionOnGatewayWithBalanceChange"): TypedContractMethod<[
        _chainId: BigNumberish,
        _canonicalTxHash: BytesLike,
        _expirationTimestamp: BigNumberish,
        _baseTokenAmount: BigNumberish,
