...
export interface IL2SharedBridgeInterface extends Interface {
    getFunction(nameOrSignature: "finalizeDeposit" | "l1Bridge" | "l1SharedBridge" | "l1TokenAddress" | "l2TokenAddress" | "withdraw"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "l1SharedBridge", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "l1SharedBridge", data: BytesLike): Result;
...
export interface IL2SharedBridge extends BaseContract {
    ...
    getFunction(nameOrSignature: "l1SharedBridge"): TypedContractMethod<[], [string], "view">;
