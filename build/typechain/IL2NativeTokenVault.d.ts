...
export interface IL2NativeTokenVaultInterface extends Interface {
    getFunction(nameOrSignature: "ASSET_ROUTER" | "WETH_TOKEN" | "assetId" | "calculateAssetId" | "calculateCreate2TokenAddress" | "getERC20Getters" | "l2TokenAddress" | "originChainId" | "registerToken" | "tokenAddress"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "BridgedTokenBeaconUpdated" | "FinalizeDeposit" | "L2TokenBeaconUpdated" | "WithdrawalInitiated"): EventFragment;
