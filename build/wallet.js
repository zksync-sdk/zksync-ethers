...
class Wallet extends (0, adapters_1.AdapterL2)((0, adapters_1.AdapterL1)(ethers_1.ethers.Wallet)) {
    ...
    async getFinalizeWithdrawalParams(withdrawalHash, index = 0, interopMode) {
        return super.getFinalizeWithdrawalParams(withdrawalHash, index, interopMode);
    }
    ...
    async populateTransaction(tx) {
        ...
        const { gasLimit, gasPrice, gasPerPubdata } = await (0, utils_1.resolveFeeData)(populated, this.provider);
