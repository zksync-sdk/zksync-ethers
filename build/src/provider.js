...
class Provider extends ethers_1.ethers.providers.JsonRpcProvider {
    ...
    static hexlifyTransaction(transaction, allowExtra) {
        ...
        result.eip712Meta = {
            gasPerPubdata: ethers_1.utils.hexValue((_a = transaction.customData.gasPerPubdataByte) !== null && _a !== void 0 ? _a : 0),
        };
    ...
    async _getPriorityOpConfirmationL2ToL1Log(txHash, index = 0) {
        ...
        const messages = Array.from(receipt.l2ToL1Logs.entries()).filter(([_, log]) => log.sender == utils_1.BOOTLOADER_FORMAL_ADDRESS);
