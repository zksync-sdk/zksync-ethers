    ...
    return class Adapter extends Base {
        ...
        async getDepositTx(transaction) {
            ...
            if ((token == utils_1.ETH_ADDRESS) && (baseTokenAddress == utils_1.ETH_ADDRESS_IN_CONTRACTS)) {
                ...
                await (0, utils_1.checkBaseCost)(baseCost, baseCost.add(operatorTip)); // this is base token, not eth
                let refundRecipient = (_m = tx.refundRecipient) !== null && _m !== void 0 ? _m : ethers_1.ethers.constants.AddressZero;
                const args = [
                    (await this._providerL2().getNetwork()).chainId,
                    to,
                    utils_1.ETH_ADDRESS_IN_CONTRACTS,
                    baseCost.add(operatorTip),
                    0,
                    tx.l2GasLimit,
                    tx.gasPerPubdataByte,
                    refundRecipient,
                ...
                let refundRecipient = (_q = tx.refundRecipient) !== null && _q !== void 0 ? _q : ethers_1.ethers.constants.AddressZero;
                const args = [
                    (await this._providerL2().getNetwork()).chainId,
                    to,
                    token,
