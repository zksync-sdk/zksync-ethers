...
import { DEFAULT_GAS_PER_PUBDATA_LIMIT, EIP712_TX_TYPE, hashBytecode, isAddressEq, resolveFeeData, serializeEip712, } from './utils';
...
export class Signer extends AdapterL2(ethers.JsonRpcSigner) {
    ...
    async populateFeeData(transaction) {
        ...
        const { gasLimit, gasPrice, gasPerPubdata } = await resolveFeeData(tx, this.provider, this.providerL2);
