import { AbstractSigner, ethers, hashMessage, TypedDataEncoder, } from 'ethers';
import { populateTransactionECDSA, populateTransactionMultisigECDSA, signPayloadWithECDSA, signPayloadWithMultipleECDSA, } from './smart-account-utils';
...
export class SmartAccount extends AbstractSigner {
    ...
    async getDeploymentNonce() {
        return await INonceHolder__factory.connect(NONCE_HOLDER_ADDRESS, this).getDeploymentNonce(await this.getAddress());
    }
    /**
    ...
    async signTypedData(domain, types, value) {
        ...
        return this.payloadSigner(TypedDataEncoder.hash(populated.domain, types, populated.value), this.secret, this.provider);
    }
    /**
