...
export interface IL1NativeTokenVaultInterface extends Interface {
  ...
  getEvent(
    nameOrSignatureOrTopic: "BridgedTokenBeaconUpdated" | "TokenBeaconUpdated"
  ): EventFragment;
  ...
  encodeFunctionData(
    functionFragment: "registerEthToken",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export namespace TokenBeaconUpdatedEvent {
  export type InputTuple = [l2TokenBeacon: AddressLike];
  export type OutputTuple = [l2TokenBeacon: string];
  export interface OutputObject {
...
export interface IL1NativeTokenVault extends BaseContract {
  ...
  getFunction(
    nameOrSignature: "registerEthToken"
  ...
  >;
  getEvent(
    key: "TokenBeaconUpdated"
  ): TypedContractEvent<
    TokenBeaconUpdatedEvent.InputTuple,
    TokenBeaconUpdatedEvent.OutputTuple,
    TokenBeaconUpdatedEvent.OutputObject
  >;
  ...
  filters: {
    ...
    "TokenBeaconUpdated(address)": TypedContractEvent<
      TokenBeaconUpdatedEvent.InputTuple,
      TokenBeaconUpdatedEvent.OutputTuple,
      TokenBeaconUpdatedEvent.OutputObject
    >;
    TokenBeaconUpdated: TypedContractEvent<
      TokenBeaconUpdatedEvent.InputTuple,
      TokenBeaconUpdatedEvent.OutputTuple,
      TokenBeaconUpdatedEvent.OutputObject
    >;
