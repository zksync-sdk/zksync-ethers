...
export class IGetters__factory {
  ...
  static createInterface(): IGettersInterface {
    return new Interface(_abi) as IGettersInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IGetters {
    return new Contract(address, _abi, runner) as unknown as IGetters;
  }
}
